...
mongoimport --db fashion --collection zappos-us_product --file /Users/kiran/Downloads/fashion/zappos-us_product.json
...
./solr start -e
./solr start -e cloud
./post -c zappos-us_product -p 7575 /Users/kiran/zappos-us_product_cleanData2.json
